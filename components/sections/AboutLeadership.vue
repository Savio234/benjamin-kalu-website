    ...
    <section class="py-8 md:py-16 lg:py-24 bg-white">
        <div class="w-[92.5%] gap-8 md:gap-12 lg:gap-16 flex flex-col lg:w-[90%] mx-auto">
            <div class="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2 lg:gap-9">
                ...
                <div class="hidden md:block relative w-full h-64 md:h-[40rem] lg:h-[42rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top" 
                        src="/images/about/anchored.png"
                    />
                </div>
                <div class="block md:hidden w-full h-64 md:h-[40rem] lg:h-[42rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top" 
            ...
            <div class="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2 lg:gap-9">
                <div class="hidden md:block relative order-2 md:order-1 w-full h-64 md:h-[40rem] lg:h-[50.25rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top" 
                        src="/images/about/architect.png"
                    />
                </div>
                <div class="block md:hidden relative order-2 md:order-1 w-full h-64 md:h-[40rem] lg:h-[50.25rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top"
                        src="/images/about/leadership_2.png"
                    />
                </div>
                <div class="order-1 md:order-2">
                    <h3 class="text-[#146634] font-adamina font-normal w-full text-2xl 
                        mb-4 md:mb-6 lg:mb-8 
                        leading-8 md:text-[2rem] md:leading-[3.2rem] hidden md:block md:w-3/4"
                    >
                        Architect of Policy <br /> Advocate for Progress
                    </h3>
                    <h3 class="text-[#146634] block md:hidden font-adamina font-normal w-full text-2xl mb-4 md:mb-6 lg:mb-8 
                        leading-8 md:text-[2rem] md:leading-[3.2rem] md:w-3/4"
                    >
                        Architect of Policy Advocate for Progress
                    </h3>
                    <p class="text-justify leading-6 font-montserrat font-medium text-sm 
                        md:text-base md:leading-7 lg:text-xl lg:leading-8 text-[#585C5B]"
                    >
                        ...
                        <ul class="pl-6 my-4 md:my-8 list-disc md:pl-8">
                            <li class="font-semibold mb-2 text-sm leading-6 md:text-base 
                                md:leading-7 lg:text-xl lg:leading-8"
                            >
            ...
            <div class="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2 lg:gap-9">
                <div class="">
                    <h3 class="text-[#146634] font-adamina font-normal mb-4 text-2xl 
                        leading-8 md:text-[2rem] md:leading-[3.2rem] md:mb-6 w-full md:w-3/4 lg:mb-8 lg:w-1/2"
                    >
                ...
                <div class="hidden md:block relative w-full h-64 md:h-[40rem] lg:h-[35.5rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top"
                        src="/images/about/constituency.png"
                    />
                </div>
                <div class="block md:hidden relative w-full h-64 md:h-[40rem] lg:h-[35.5rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top"
            ...
            <div class="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2 lg:gap-9">
                <div class="hidden md:block relative order-2 md:order-1 w-full h-64 md:h-[40rem] lg:h-[35.5rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top"
                        src="/images/about/strategic.png"
                    />
                </div>
                <div class="block md:hidden relative order-2 md:order-1 w-full h-64 md:h-[40rem] lg:h-[35.5rem]">
                    <NuxtImg alt="" class="w-full h-full rounded-2xl object-cover object-top"
                        src="/images/about/leadership_4.png"
                    />
                </div>
                <div class="order-1 md:order-2">
                    <h3 class="text-[#146634] font-adamina mb-4 font-normal text-2xl 
                        leading-8 md:text-[2rem] md:leading-[3.2rem] md:mb-6 lg:mb-8"
                    >
