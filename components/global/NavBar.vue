    ...
    <div class="flex flex-col h-screen gap-6 mx-auto w-[90%]">
      ...
      <div>
        <button @click="toggleSection('legislative')" class="w-full text-left text-white py-2 px-4 rounded-full focus:outline-none flex justify-between items-center">
          Legislative Affairs
          <font-awesome-icon :icon="['fas', 'chevron-down']" :class="{'rotate-180': openSection === 'legislative', 'rotate-0': openSection !== 'legislative'}" class="transform transition-transform duration-300"></font-awesome-icon>
        </button>
      ...
      <div>
        <button @click="toggleSection('projects')" class="w-full text-left text-white py-2 px-4 rounded-full focus:outline-none flex justify-between items-center">
          Projects
          <font-awesome-icon :icon="['fas', 'chevron-down']" :class="{'rotate-180': openSection === 'projects', 'rotate-0': openSection !== 'projects'}" class="transform transition-transform duration-300"></font-awesome-icon>
        </button>
        <transition name="accordion">
