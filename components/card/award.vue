<template>
  <div class="w-4/5 md:w-1/3 lg:w-1/4 shrink-0 rounded-xl flex flex-col cursor-pointer bg-white my-3">
...
defineProps({
  ...
  title: {
    type: String,
    required: false,
    default: 'Know who your Deputy speaker is (Auto-Biography)',
  },
  description: {
    type: String,
    required: false,
